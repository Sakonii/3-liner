...
class Detection:
    ...
    def __init__(self, modelWeights, cfgPath):
        ...
        self._predict = DefaultPredictor(self.cfg)
    ...
    def tensor_to_np(self):
        "Convert Tensors to OpenCV Compatible Types"
    ...
    def show(self):
        ...
        cv2.imshow(winname="Oonta", mat=self.img_display)
        cv2.waitKey(0)
    ...
    def predict(self, img: np.array):
        ...
        # Model Prediction
        self.outputs = self._predict(img)
        self.tensor_to_np()
        # self.show()
